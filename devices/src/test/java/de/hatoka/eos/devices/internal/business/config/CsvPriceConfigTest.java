...
public class CsvPriceConfigTest
{
    ...
    public void testCsvStockEnergyPriceProviderCreation() throws IOException
    {
        ...
        de.hatoka.eos.devices.capi.business.forecast.EnergyPriceForecast priceProvider = gridConfig.getEnergyPriceProvider();
        
        assertNotNull(priceProvider);
        assertInstanceOf(de.hatoka.eos.devices.internal.business.forecast.CsvStockEnergyPriceProvider.class, priceProvider);
